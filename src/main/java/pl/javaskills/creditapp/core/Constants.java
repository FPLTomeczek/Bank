...
public class Constants {
    ...
    public static final String LASTNAME_REGEX;
    ...
    static {
        ...
        MIN_LOAN_AMOUNT_MORTGAGE = 100_000.00;
        DOUBLE_REGEX = "[0-9]+(\\.[0-9]+)?";
        INT_REGEX = "\\d+";
        NAME_REGEX = "[A-ZĄ-Ź][a-zą-ź]{2,9}";
        LASTNAME_REGEX = "[A-ZĄ-Ź][a-zą-ź]+(\\s)?(-)?([A-ZĄ-Ź][a-zą-ź]+)?";
        EMAIL_REGEX = ".+@.+";
        PHONE_NUMBER_REGEX = "\\+?([0-9]?){2}[0-9]{9}";
    }
