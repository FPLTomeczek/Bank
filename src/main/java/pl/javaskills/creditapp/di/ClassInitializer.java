...
public class ClassInitializer {
    ...
    private Object getInstance(Class classToInstantiate) throws Exception {
        ...
        {
            System.out.println("Creating instance of class " + classToInstantiate.getCanonicalName() + " from cache");
        ...
        System.out.println("Created instance of class " + classToInstantiate.getCanonicalName());
